...
[ zero.sixty zero.onet zero.twofor zero.three ] = getACC_con( RT_ALL, [0]);
[ sixty.sixty sixty.onet sixty.twofor sixty.three ] = getACC_con( RT_ALL, [60]);
[ three.sixty three.onet three.twofor three.three ] = getACC_con( RT_ALL, [300]);

[ all.sixty all.onet all.twofor all.three ] = getACC_con( RT_ALL, [0 60 300]);
