...
[~,tbl,stats] = anovan(dat_amp_feet_P3,{nms_all_grp,nms_all_con,nms_all_ang},'model','interaction','varnames',{'Group','Condition','Angle'})
figure
multcompare(stats,'Dimension',[1 2 3])
title 'Multicompare feet ERPs'
xlabel 'mean Amplitude [\muV]'
save_fig(gcf,PATHOUT_plots,'mltcmpr_fERPs_ANOVA');
writecell(tbl,[PATHOUT_plots 'tbl_fERPs_ANOVA.xls']);
